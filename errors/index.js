...
(function() {
  var Conflict, InvalidAccess, LoginError, NoTask, UnknownMail, UnknownTemplate, UnknownUser,
  ...
  UnknownTemplate = (function(superClass) {
    extend(UnknownTemplate, superClass);

    function UnknownTemplate(message) {
      this.message = message != null ? message : "Unknown template.";
